...
return (
  <div>
        ...
        <h3 className="text-3xl font-bold flex flex-row items-center">
          <svg className="w-12 h-12" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
            <path fill="#FFB446" d="M97.103,353.103C97.103,440.86,168.244,512,256,512l0,0c87.756,0,158.897-71.14,158.897-158.897..." />
          </svg>  
